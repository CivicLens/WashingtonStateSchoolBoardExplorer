# Meeting Summaries for EAST_VALLEY_SCHOOL_DISTRICT in 2024
...
| [Jonathan Horsley](board_member_284.md) | voted yes on the motion to approve consent items | Approved as presented. |
...
The Regular Board Meeting held on January 9, 2024, included discussions on various agenda items, notably the approval of the 2023-24 School Improvement Plans. The board, comprised of members Mike Bly, Justin Voelker, Theresa Noack, and Jonathan Horsley, unanimously approved the consent agenda, which included financial vouchers for December bills totaling $273,267.27, as well as payroll payments. A significant donation of $1,899.58 from the East Valley Booster Club was approved for volleyball uniforms. The meeting also featured a strategic planning presentation led by Dr. Tammy Campbell, and Mr. Voelker reported on a recent wrestling match, while Ms. Noack reminded attendees about the upcoming Golden Throne game. The board convened an executive session to review the performance of a public employee, after which the personnel report was approved. The meeting concluded at 7:50 PM. 
...
| Board Member | Position Supported | Context |
|--------------|--------------------|---------|
| [Mike Bly](board_member_285.md) | voted yes on removing the personnel report from the consent agenda | With a motion made by Theresa Noack, seconded by Mike Bly, all were in favor of removing the personnel report from the c...[truncated, use api for full text] |
| [Mike Bly](board_member_285.md) | voted yes on approving the minutes of the December 12, 2023 Regular Board Meeting | Motion by Mike Bly, second by Jonathan Horsley. Final Resolution: Motion Carries. |
| [Mike Bly](board_member_285.md) | voted yes on approving vouchers for payment of December bills | Approved ACH Numbers 232400534 through 232400598 in the amount of $273,267.27 for payment of December bills. |
| [Mike Bly](board_member_285.md) | voted yes on approving a donation from the East Valley Booster Club | Approved a donation of $1,899.58 from the East Valley Booster Club to be used towards volleyball uniforms. |
| [Mike Bly](board_member_285.md) | voted yes on approving the PEP program fundraising activities | Approved the PEP program fundraising activities for February 8, 2024, and April 18, 2024. |
| [Mike Bly](board_member_285.md) | voted yes on approving the 2023-24 School Improvement Plans | Approved the 2023-24 School Improvement Plans. |
| [Mike Bly](board_member_285.md) | voted yes on approving the personnel report | With a motion made by Mike Bly, seconded by Theresa Noack, all were in favor of approving the personnel report. |
| [Justin Voelker](board_member_283.md) | voted yes on removing the personnel report from the consent agenda | With a motion made by Theresa Noack, seconded by Mike Bly, all were in favor of removing the personnel report from the c...[truncated, use api for full text] |
| [Justin Voelker](board_member_283.md) | voted yes on approving the minutes of the December 12, 2023 Regular Board Meeting | Motion by Mike Bly, second by Jonathan Horsley. Final Resolution: Motion Carries. |
| [Justin Voelker](board_member_283.md) | voted yes on approving vouchers for payment of December bills | Approved ACH Numbers 232400534 through 232400598 in the amount of $273,267.27 for payment of December bills. |
| [Justin Voelker](board_member_283.md) | voted yes on approving a donation from the East Valley Booster Club | Approved a donation of $1,899.58 from the East Valley Booster Club to be used towards volleyball uniforms. |
| [Justin Voelker](board_member_283.md) | voted yes on approving the PEP program fundraising activities | Approved the PEP program fundraising activities for February 8, 2024, and April 18, 2024. |
| [Justin Voelker](board_member_283.md) | voted yes on approving the 2023-24 School Improvement Plans | Approved the 2023-24 School Improvement Plans. |
| [Justin Voelker](board_member_283.md) | voted yes on approving the personnel report | With a motion made by Mike Bly, seconded by Theresa Noack, all were in favor of approving the personnel report. |
| [Jonathan Horsley](board_member_284.md) | voted yes on removing the personnel report from the consent agenda | With a motion made by Theresa Noack, seconded by Mike Bly, all were in favor of removing the personnel report from the c...[truncated, use api for full text] |
